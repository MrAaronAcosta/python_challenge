...
#Instructions: create a Python script that analyzes the records to calculate:

#   The total number of months included in the dataset 
#   Net Revenue (Profits/Losses) of entire Period
#   Average MoM change in Revenue (Profits/Losses) for the entire period
...
#    /Users/ixmx1804/Desktop/BootCamp/COMPLETE COURSE/02-Homework/03-Python/Instructions/PyBank/Resources/budget_data.csv
...
while file_test == "n":
    ...
    if (not os.path.isfile(budget_csv_path)): # file path verification
        print()
        print("User Entry Error: File not found. Please re-enter!" )
        print()
        file_test = "n"
    else:
        file_test = "y"
    ...
    for row in data:
        ...
        if first_read == "y":
            ...
            if change_amt > max_increase_amt:
                ...
                # Although not present in this file set,
                # this line reserved for future coding to allow for possibility of multiple dates 
                # with the same maximum increase amt  - use append 
            else:
                max_increase_amt = max_increase_amt
            ...
            if change_amt < max_decrease_amt:
                ...
                # Although not present in this file set,
                # this line reserved for future coding to allow for possibility of multiple dates 
                # with the same maximum decrease amt - muse append
            else:
                max_decrease_amt = max_decrease_amt
...
# Create text file report lines__________________________
